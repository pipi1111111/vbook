...
func (c *CodeRedis) Set(ctx context.Context, biz, phone, code string) error {
...
func (c *CodeRedis) Verify(ctx context.Context, biz, phone, code string) (bool, error) {
...
func (c *CodeRedis) key(biz, phone string) string {
